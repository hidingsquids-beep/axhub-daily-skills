...
使用 `/src/resources/templates/work-summary-template.md` 中对应格式的模板，填入扫描结果，生成结构化总结。
...
`src/resources/templates/work-summary-template.md`
