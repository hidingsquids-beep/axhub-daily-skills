...
无法访问 GitHub 的朋友，可以直接下载 zip 包：[darwin-skill.zip](https://pub-161ae4b5ed0644c4a43b5c6412287e03.r2.dev/skills/darwin-skill.zip)，解压后把完整目录放到你当前 Agent 支持的个人级或项目级 skills 目录中，例如 `$CODEX_HOME/skills/darwin-skill/`、项目 `.agents/skills/darwin-skill/`，或其他 runtime 的等效 skills 目录。
