...
Can't access GitHub? Download the zip: [darwin-skill.zip](https://pub-161ae4b5ed0644c4a43b5c6412287e03.r2.dev/skills/darwin-skill.zip). Extract the full directory into the personal or project-level skills folder supported by your agent, such as `$CODEX_HOME/skills/darwin-skill/`, project `.agents/skills/darwin-skill/`, or the equivalent skills directory for your runtime.
